...
export function PhoneForm() {
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
          </div>
      ...
      <div>
        <label htmlFor="sms-code" className="block text-sm font-medium text-gray-700 mb-1.5">验证码</label>
        <div className="flex gap-3">
          ...
          <button type="button" onClick={sendSmsCode} disabled={countdown > 0} className={cn("h-11 px-5 rounded-lg text-sm font-medium whitespace-nowrap transition-colors", countdown > 0 ? "border border-gray-200 bg-gray-50 text-gray-400 cursor-not-allowed" : "border border-brand-200 bg-brand-50 text-brand-600 hover:bg-brand-100")}>
