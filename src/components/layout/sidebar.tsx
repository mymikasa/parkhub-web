        ...
        <div className="p-4 border-t border-white/10">
          <div className="relative" ref={userMenuRef}>
            <button
              ...
              className="w-full flex items-center gap-3 rounded-lg p-1 -m-1 hover:bg-white/5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            >
            ...
            {userMenuOpen && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-white rounded-xl shadow-xl border border-gray-100 py-1.5 overflow-hidden z-50">
                <Link
                  href={ROUTES.PROFILE}
